...
export const SignUp = ({ controller }: SignUpProps) => {
            ...
            <Stack spacing={3.5}>
                <Box>
                    ...
                    <Stack spacing={2.5}>
                        ...
                        <TextField
                            ...
                            slotProps={{
                                input: {
                                    endAdornment: (
                                        <InputAdornment sx={{ bgcolor: "#fff" }} position="end">
                                            <IconButton edge="end">
                    ...
                    >
                        ...
                        >
                            Already have an account? <Typography component="span" color="#c08a97">Login</Typography>
                        </Typography>
                    </Box>
                </Box>
